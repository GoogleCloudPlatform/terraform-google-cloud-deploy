# Single\_Project\_Private\_Gke

This example is to create delivery pipelines, deploy targets , worker\_pool and their respective service accounts.
...
Private GKE cluster creation in the same project.
